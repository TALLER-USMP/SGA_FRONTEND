...
export default function CoordinatorEmail() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const validBySize = toAdd.filter((f) => f.size <= MAX_FILE_BYTES);
  ...
  const handleSend = async () => {
    try {
      await sendMail({ to, subject, body, files });
      setTo("");
      setSubject("");
      setBody("");
      setFiles([]);
      ...
      // Los errores ya están manejados por el hook con toasts
