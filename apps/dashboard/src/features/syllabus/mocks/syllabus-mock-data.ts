...
export const mockSyllabusData: CompleteSyllabus = {
  ...
  estrategiasMetodologicas:
    "Método del pensamiento de diseño - Los estudiantes identifican el problema con mayor exactitud, son incluidos en un proceso de creación, innovación y colaboración constante, desarrolla habilidades de empatía y emprendimiento. Método basado en proyectos - Los estudiantes son enfrentados a una situación problemática real, promueve y fomenta el trabajo en equipo, la autocapacitación y la autogestión para el desarrollo de un producto final.",
