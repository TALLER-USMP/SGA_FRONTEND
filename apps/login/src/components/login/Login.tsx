...
function Login() {
  ...
  const sendTokenToBackend = async (token: string) => {
    try {
      ...
      console.warn("No se pudo enviar el token al backend (modo dev):", err);
      try {
    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="md:w-1/2 flex flex-col justify-center items-center px-8 py-12 bg-white">
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded-lg shadow-md transition-transform transform hover:scale-105"
        >
